...
function Intro() {
    ...
    return (
        <div className="font-sans max-w-screen h-fit max-md:h-screen">
            <div className="w-full xl:h-screen max-lg:h-[50vh] bg-black flex items-center">
            ...
            <div className="bg-[url('./assets/bg-journey.webp')] bg-cover bg-center lg:h-screen max-lg:h-[50vh] w-full flex justify-center items-center">
                <button className=' w-[278px] max-lg:w-1/3 max-[500px]:w-1/2 h-20 max-md:h-14 bg-white/50 hover:bg-white/20 rounded-2xl border-white border-2 shadow-blue-800 shadow-md' onClick={() => navigate('/home')}>
