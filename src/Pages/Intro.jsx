...
function Intro() {
    ...
    return (
        <div className="font-sans max-w-screen h-fit max-md:h-screen">
            ...
            <button className='absolute bottom-10 left-1/2 transform -translate-x-1/2 bottom  w-[278px] max-lg:w-1/3 max-[500px]:w-1/2 h-20 max-md:h-14 bg-gray-700 hover:bg-white/20 rounded-2xl border-white border-2 shadow-blue-800 shadow-md' onClick={() => navigate('/home')}>
